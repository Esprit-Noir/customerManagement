...
const AddEditCustomer = () => {
  ...
  const addCustomer = (data) => {
    CustomerService.postCustomer(data).then((res) => {
      nav("/");
    });
  };

  const editCustomer = (id, data) => {
    CustomerService.updateCustomerById(id, data).then((res) => {
      nav("/");
    });
  };
          ...
          <div className="card shadow">
            ...
            <div className="card-body">
              ...
              <div className="d-grid">
                {modeAdd ? (
                  <button className="btn text-light main-bg btn-success">
                    ajouter
                  </button>
                ) : (
                  <button className="btn text-light main-bg btn-info">
                    Mettre à jour
                  </button>
                )}
              </div>
